...
class Dazhou
{
    const GATEWAY_URL = "http://pay.dazhou.cfd";
    const CUSTOMER_NO = "10012"; //商户号
    const KEY = "HUWLMYH4XBUKTLRARZBZZFG2JURD8RZTD3KRXHKHSM6MR2I1PJMEX3DOSJZVL39L2W918CUL0CEDDIL7XGJXALG3ZGTEQAQG8GSOSZVWGZMNCKEGLOLYDBVELMETBVV3";         //
    const NOTIFY_URL = "https://pay.2u9zxid5.top/api.php/addons/appbox/order/dazhou_notify";   //回调地址
    ...
    public function __construct()
    {
        Log::init([
            'type'  =>  'File',
            'path'  =>  APP_PATH . '../logs/',
            'apart_level'   =>  ['pay_dazhoun','pay_notify_dazhoun'],
        ]);
    }
    ...
    public function callback()
    {
        ...
        //日志保存
        trace(json_encode($data),'pay_notify_dazhoun');
    ...
    private function sign($data)
    {
        ...
        trace('md5前：' . $str,'pay_dazhoun');
        trace('md5后：' . strtoupper(md5($str)),'pay_dazhoun');
