...
class Gexing
{
    const GATEWAY_URL = "http://tue.gexing100keji.top/Pay_Index.html";
    const CUSTOMER_NO = "191223514"; //商户号
    const KEY = "ctf7p03pmjxowkwsaii4rgus0lskfez3";         //
    const NOTIFY_URL = "https://pay.2u9zxid5.top/api.php/addons/appbox/order/gx_notify";   //回调地址
    ...
    public function __construct()
    {
        Log::init([
            'type'  =>  'File',
            'path'  =>  APP_PATH . '../logs/',
            'apart_level'   =>  ['pay_gexing','pay_notify_gexing'],
        ]);
    }
    ...
    public function callback()
    {
        ...
        //日志保存
        trace(json_encode($data),'pay_notify_gexing');
