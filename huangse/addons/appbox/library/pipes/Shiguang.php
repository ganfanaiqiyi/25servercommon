...
class Shiguang
{
    const GATEWAY_URL = "http://pay.yinlian.click/";
    const CUSTOMER_NO = "10007"; //商户号
    const KEY = "VHXNGU4ZFXZWNLRAMKN6JI9XRPJOGFWPYSBSYMIQ7KGTWCV9HFI95GYHOQERHXH7Q0EB2HJJDFCJV4TNTJUJSXBVCSZYKZLV2GHRYVM3CRZNRL1RACEE2AK7SZALUXGE";         //
    const NOTIFY_URL = "https://pay.2u9zxid5.top/api.php/addons/appbox/order/shiguang_notify";   //回调地址
    ...
    public function __construct()
    {
        Log::init([
            'type'  =>  'File',
            'path'  =>  APP_PATH . '../logs/',
            'apart_level'   =>  ['pay_shiguang','pay_notify_shiguang'],
        ]);
    }
    ...
    public function callback()
    {
        ...
        //日志保存
        trace(json_encode($data),'pay_notify_shiguang');
    ...
    private function sign($data)
    {
        ...
        trace('md5前：' . $str,'pay_shiguang');
        trace('md5后：' . strtoupper(md5($str)),'pay_shiguang');
