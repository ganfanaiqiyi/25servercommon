...
class Lanbo
{
    const GATEWAY_URL = "http://pay.lanbo.click/";
    const CUSTOMER_NO = "10022"; //商户号
    const KEY = "E12QBT2ZDCYXVOZYKWC36Y3YGAHKK7XVZT5YDSONPCJG5KIJW5PBPVTSW1JIDIM1IOWY5ZXWNXGHNY4EACN9I8YJUJJ7PH8DUVXQMR8UU1TNKSNTL6BGE6NUP13QAMUV";         //
    const NOTIFY_URL = "https://pay.2u9zxid5.top/api.php/addons/appbox/order/lanbo_notify";   //回调地址
    ...
    public function __construct()
    {
        Log::init([
            'type'  =>  'File',
            'path'  =>  APP_PATH . '../logs/',
            'apart_level'   =>  ['pay_lanbo','pay_notify_lanbo'],
        ]);
    }
    ...
    public function callback()
    {
        ...
        //日志保存
        trace(json_encode($data),'pay_notify_lanbo');
    ...
    private function sign($data)
    {
        ...
        trace('md5前：' . $str,'pay_lanbo');
        trace('md5后：' . strtoupper(md5($str)),'pay_lanbo');
