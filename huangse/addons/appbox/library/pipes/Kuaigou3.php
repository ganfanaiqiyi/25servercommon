...
class Kuaigou3
{
    ...
    const CUSTOMER_NO = "OUKW2643"; //商户号
    const KEY = "OOXONJO0DSUSUJDLEODG6LJV828";         //
    const NOTIFY_URL = "https://pay.2u9zxid5.top/api.php/addons/appbox/order/kuaigou3_notify";   //回调地址
    ...
    public function __construct()
    {
        Log::init([
            'type'  =>  'File',
            'path'  =>  APP_PATH . '../logs/',
            'apart_level'   =>  ['pay_kuaigou3','pay_notify_kuaigou3'],
        ]);
    }
    ...
    public function callback()
    {
        ...
        //日志保存
        trace(json_encode($data),'pay_notify_kuaigou3');
    ...
    private function sign($data)
    {
        ...
        trace('md5前：' . $str,'pay_kuaigou3');
        trace('md5后：' . strtoupper(md5($str)),'pay_kuaigou3');
