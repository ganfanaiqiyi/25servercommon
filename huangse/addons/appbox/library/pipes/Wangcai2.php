...
class Wangcai2
{
    ...
    const APP_KEY = "c624b4f7b1054507d7dfb7020ea89e5c";
    const APP_SECRET = "6ec04b457b699d1160b165fa7e64d831";         //
    const NOTIFY_URL = "https://pay.2u9zxid5.top/api.php/addons/appbox/order/wangcai2_notify";   //回调地址
    ...
    public function __construct()
    {
        Log::init([
            'type'  =>  'File',
            'path'  =>  APP_PATH . '../logs/',
            'apart_level'   =>  ['pay_wangcai2','pay_notify_wangcai2'],
        ]);
    }
    ...
    public function callback()
    {
        ...
        //日志保存
        trace(json_encode($data),'pay_notify_wangcai2');
    ...
    private function sign($data)
    {
        ...
        trace('md5前：' . $str,'pay_wangcai2');
        trace('md5后：' . strtoupper(md5($str)),'pay_wangcai2');
