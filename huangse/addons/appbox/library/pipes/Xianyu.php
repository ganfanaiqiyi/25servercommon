...
class Xianyu
{
    const GATEWAY_URL = "http://pay.xianyu.click/";
    const CUSTOMER_NO = "10042"; //商户号
    const KEY = "ZP6ACK3TO1BAWOQP3XJDW6DB4SA48DIWIISRPRK3YYGS3EUMYXIHZVZVS4BWMLIVTCUAUAPBZWMEVU4X0P7HQU4QPCTRN5X73BSCZ7YQTOG7RU4HIFGOBXU8BHPEWILR";         //
    const NOTIFY_URL = "https://pay.2u9zxid5.top/api.php/addons/appbox/order/xianyu_notify";   //回调地址
    ...
    public function __construct()
    {
        Log::init([
            'type'  =>  'File',
            'path'  =>  APP_PATH . '../logs/',
            'apart_level'   =>  ['pay_xianyu','pay_notify_xianyu'],
        ]);
    }
    ...
    public function callback()
    {
        ...
        //日志保存
        trace(json_encode($data),'pay_notify_xianyu');
    ...
    private function sign($data)
    {
        ...
        trace('md5前：' . $str,'pay_xianyu');
        trace('md5后：' . strtoupper(md5($str)),'pay_xianyu');
