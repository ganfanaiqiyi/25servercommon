...
class Dajiafa
{
    ...
    const CUSTOMER_NO = "10025"; //商户号
    const KEY = "GVIQPOYX9MJM1OJGKH0YQSWEXUOBGVSFWWFCJ07UEMN7BNKBEWJT16SPDIRWQCL1MOGSBRCIKM5UJB5QEXLWZRZFYXLX7I0GCWLUJ3MFTCBYWMKLZVDIQGUCBDJJNBLH";         //
    const NOTIFY_URL = "https://pay.2u9zxid5.top/api.php/addons/appbox/order/dajiafa_notify";   //回调地址
