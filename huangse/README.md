...
location / {
	if (!-e $request_filename){
	  rewrite ^/apk/(.*)\.apk$ /index.php/index/index/apk?channel=$1 last;
	  rewrite ^/downloads/(.*)\.apk$ /index.php/index/apk?channel=$1 last;
	  rewrite ^/goa/(\d+)$ /ad.php/index/index/goAdUrl?id=$1 last;
